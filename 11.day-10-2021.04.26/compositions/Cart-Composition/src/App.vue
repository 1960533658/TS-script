...
<div class="container">
  <div class="cart">
    ...
    <CartList :product-list="productList" @del="deleteProduct" @add="handleAdd"></CartList>
...
export default defineComponent({
  setup() {
    // 定义名字
    const userName = ref<string>("康康")
    // 定义商品数据
    const productList: Array<productItem> = reactive([
       {
          id: 1,
          name: "TCL彩电",
          price: 1000,
    ...
    const deleteProduct = function (id) {
      let index = productList.findIndex((item: productItem) => item.id == id);
